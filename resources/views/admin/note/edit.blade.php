...
@section('content')
    <div class="area">
        <main class="admin-area">
            <div class="admin-area__heading">Редактирование записки</div>

            <div class="admin-area__content">
                ...
                <div class="admin-area-notes__content">
                    ...
                    <form class="admin-add admin-notes-edit-block" id="create" name="create"
                          method="POST" action="{{ route('admin.block.create', ['id' => $note->id]) }}">
                        {{ csrf_field() }}

                        <div class="admin-add__heading">Добавить блок</div>
