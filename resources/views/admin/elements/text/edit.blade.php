...
<form class="notes-block-content" id="create" name="create"
      method="POST" action="{{ route('admin.block.text.edit', ['note_id' => $block->note_id, 'id' => $block->id]) }}">
    {{ csrf_field() }}
    <h1>Текст</h1>
    <div class="">
    ...
    <div class="">
        <label for="heading" class="">Подзаголовок</label>
    ...
    <div class="">
        <label for="content" class="">Содержимое</label>
